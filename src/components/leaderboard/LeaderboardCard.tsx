...
export function LeaderboardCard({ row, highlighted = false }: { row: LeaderboardRowSummary; highlighted?: boolean }) {
  return (
    <div
      className={cn(
      "interactive-card group relative overflow-hidden rounded-[26px] border border-white/8 bg-card/70 p-4 backdrop-blur-xl transition-all duration-300 hover:border-primary/25 hover:bg-card/80 hover:shadow-[0_26px_80px_rgba(10,18,32,0.45)]",
