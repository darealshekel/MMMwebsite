...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn("text-sm leading-[1.7] tracking-[0.06em]", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cn("text-[10px] leading-[1.9] text-muted-foreground", className)} {...props} />
));
